...
from models.WaveFrSnow import WaveFrSnow
...
parser.add_argument('--model_path', type=str,
                    default='/mnt/ai2022_tr/dxw/DeSnow/Ensample/CSD-WaveFrSnow.pth', help='path of SnowFormer checkpoint')
